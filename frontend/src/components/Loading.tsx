...
const Loading : FC<{small ?: boolean}> = ({ small }) => (
  <div className={`${small ? "absolute h-full w-full" : "absolute h-screen w-screen top-0 left-0"} z-50 flex justify-center align-middle items-center backdrop-blur-md`}>
